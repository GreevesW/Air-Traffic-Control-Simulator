...
public class Altitudeinput : MonoBehaviour
{
    ...
    public void ReadAltitudeInput(string i)
    {
        input = i;

        //casts the string input as an int
        //rbmovement.target_altitude = Int32.Parse(input);

        MindScript.CurrentPlayer.GetComponent<rbmovement>().target_altitude = Int32.Parse(input);
